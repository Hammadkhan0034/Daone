import '../home_one_screen/widgets/completedtask1_item_widget.dart';
                          ...
                          child: Obx(
                            () => ListView.separated(
                              ...
                              itemCount: controller.homeOneModelObj.value
                                  .completedtask1ItemList.value.length,
                              itemBuilder: (context, index) {
                                Completedtask1ItemModel model = controller
                                    .homeOneModelObj
                                    .value
                                    .completedtask1ItemList
                                    .value[index];
                                return Completedtask1ItemWidget(
                                  model,
                                );
                              },
                            ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      CustomDropDown(
                        ...
                        items: controller
                            .homeOneModelObj.value.dropdownItemList.value,
