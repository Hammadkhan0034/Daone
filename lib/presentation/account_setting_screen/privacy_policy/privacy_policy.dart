            ...
            child: Column(
              ...
              children: [
               ...
               // SizedBox(height: 16.0),
                TextWidget(text:'Privacy Policy', color:Colors.deepOrange, fsize: 18),
                SizedBox(height: 16.0),
                TextWidget(
                ...
                SizedBox(height: 16.0),
                TextWidget(text:  'Data Collection', color:Colors.deepOrange, fsize: 18),
                SizedBox(height: 8.0),
                TextWidget(
                    ...
                    color:Colors.black, fsize: 12),
                SizedBox(height: 16.0),
                TextWidget(text:  'Data Usage', color:Colors.deepOrange, fsize: 18),
                ...
                TextWidget(
                   text: 'We use the collected data for various purposes, including providing and improving our app, personalizing user experiences, and analyzing app usage patterns.',
                    color:Colors.black, fsize: 12),
                SizedBox(height: 16.0),
                TextWidget(text:  'Data Sharing', color:Colors.deepOrange, fsize: 18),
                ...
                TextWidget(
                   text: 'We may share your information with third parties only in cases where it is necessary for providing our services or as required by law.',
                    color:Colors.black, fsize: 12),
                SizedBox(height: 16.0),
                TextWidget(text:  'Security', color:Colors.deepOrange, fsize: 18),
                SizedBox(height: 8.0),
                TextWidget(
