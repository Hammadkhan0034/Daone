...
onTapGradeyourself() { Get.dialog(AlertDialog(backgroundColor: Colors.transparent, contentPadding: EdgeInsets.zero, insetPadding: const EdgeInsets.only(left: 0), content:GradeYourselfDialog(Get.put(GradeYourselfController(),),),)); } 
...
/// which is obtained using the Get.put() method.
onTapAddTaskPopUpCalender() { Get.dialog(AlertDialog(backgroundColor: Colors.transparent, contentPadding: EdgeInsets.zero, insetPadding: const EdgeInsets.only(left: 0), content:AddTaskPopUpCalenderDialog(Get.put(AddTaskPopUpCalenderController(),),),)); } 
...
/// which is obtained using the Get.put() method.
onTapSaveorEditBlog() { Get.dialog(AlertDialog(backgroundColor: Colors.transparent, contentPadding: EdgeInsets.zero, insetPadding: const EdgeInsets.only(left: 0), content:SaveOrEditBlogDialog(Get.put(SaveOrEditBlogController(),),),)); } 
...
/// which is obtained using the Get.put() method.
onTapCommentSectionOne() { Get.dialog(AlertDialog(backgroundColor: Colors.transparent, contentPadding: EdgeInsets.zero, insetPadding: const EdgeInsets.only(left: 0), content:CommentSectionOneDialog(Get.put(CommentSectionOneController(),),),)); } 
...
/// which is obtained using the Get.put() method.
onTapAddnewfriends() { Get.dialog(AlertDialog(backgroundColor: Colors.transparent, contentPadding: EdgeInsets.zero, insetPadding: const EdgeInsets.only(left: 0), content:AddNewFriendsDialog(Get.put(AddNewFriendsController(),),),)); } 
