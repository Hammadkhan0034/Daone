...
class SelfConfidenceAffirmationView extends StatefulWidget {
  const SelfConfidenceAffirmationView({Key? key}) : super(key: key);

  @override
  State<SelfConfidenceAffirmationView> createState() => _SelfConfidenceAffirmationViewState();
}

class _SelfConfidenceAffirmationViewState extends State<SelfConfidenceAffirmationView> with SingleTickerProviderStateMixin{
                                ...
                                content: SelfConfidenceAffirmationBlastEffectDialog(Get.put(SelfConfidenceController()),
                                    ...
                                    decorationImage: DecorationImage(
                                      image: CachedNetworkImageProvider(
                                        selfAffirmationData['imageUrl'] ?? "https://images.unsplash.com/photo-1483197452165-7abc4b248905?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8NHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&q=60",
                                      ),
                                      fit: BoxFit.cover,
